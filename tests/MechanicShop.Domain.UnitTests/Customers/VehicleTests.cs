...
public class VehicleTests
{
    ...
    public void UpdateVehicle_ShouldFail_WhenMakeIsInvalid()
    {
        ...
        var result = vehicle.Update(string.Empty, "Camry", 2022, "XYZ 789");
        Assert.True(result.IsError);
    }
    ...
    public void UpdateVehicle_ShouldFail_WhenModelIsInvalid()
    {
        ...
        var result = vehicle.Update("Toyota", string.Empty, 2022, "XYZ 789");
        Assert.True(result.IsError);
    }
    ...
    public void UpdateVehicle_ShouldFail_WhenLicensePlateIsInvalid()
    {
        ...
        var result = vehicle.Update("Toyota", "Camry", 2022, string.Empty);
        Assert.True(result.IsError);
    }
    ...
    public void UpdateVehicle_ShouldFail_WhenYearInvalid(int year)
    {
        ...
        var result = vehicle.Update("Updated Toyota", "Updated Camry", year, "Updated XYZ 789");
        Assert.True(result.IsError);
    }
