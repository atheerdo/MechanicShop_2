...
{
    [Fact]
    public void CreateCustomer_ShouldSuccess_WithValidDate()
    {
        var id = Guid.NewGuid();
        const string name = "Customer #1";
        const string phoneNumber = "3333333222222";
        const string email = "customer#1@localhost";
        ...
        Assert.Equal(vehicles, vehicles);
    }
    ...
    [InlineData("12345678910111212")] // greater than 15
    ...
    public void UpdateCustomer_ShouldFail_WhenInvalidPhoneNumber()
    {
        ...
        var result = customer.Update("Updated Name", "updated@email.com", "123");
        Assert.True(result.IsError);
    ...
    public void UpdateCustomer_ShouldFail_WhenInvalidEmail()
    {
        ...
        var result = customer.Update("Updated Name", "$gmail.com", "1234567890");
        Assert.True(result.IsError);
