...
public class WorkOrderTests
{
    ...
    [Fact]
    public void UpdateLabor_ShouldReturnError_WhenLaborIdIsEmpty()
    {
        var wo = WorkOrder.Create(
            id: Guid.NewGuid(),
            vehicleId: Guid.NewGuid(),
    ...
    public void UpdateState_ShouldReturnError_WhenTransitionInvalid()
    {
        ...
        Assert.Equal(
            ...
            WorkOrderState.Scheduled, WorkOrderState.Completed).Code, result.TopError.Code);
    }
    ...
    public void UpdateTiming_ShouldReturnSuccess_AndSetNewTiming()
    {
        ...
        var newEnd = DateTimeOffset.UtcNow.AddHours(2);
    ...
    public void UpdateState_ShouldReturnSuccess_AndSetStateToInProgress()
    {
        ...
        Assert.True(result.IsSuccess);
        Assert.Equal(newState, wo.State);
    }
}