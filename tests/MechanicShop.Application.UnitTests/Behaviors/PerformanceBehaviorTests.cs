...
public class PerformanceBehaviorTests
{
    ...
    private readonly PerformanceBehaviour<TestRequest, TestResponse> _behavior;
    ...
    public PerformanceBehaviorTests()
    {
        ...
        _behavior = new PerformanceBehaviour<TestRequest, TestResponse>(
            _logger,
            _user,
            _identityService);
    }
    ...
    public async Task Handle_WhenRequestTakesLessThan500Ms_ShouldNotLogWarning()
    {
        ...
        // Act
        var result = await _behavior.Handle(request, (_) => Task.FromResult(expectedResponse), cancellationToken);
    ...
    public async Task Handle_WhenRequestTakesMoreThan500Ms_ShouldLogWarning()
    {
        ...
        // Act
        var result = await _behavior.Handle(request, async (_) =>
        {
    ...
    public async Task Handle_WhenNextThrowsException_ShouldNotCatchException()
    {
        ...
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            () => _behavior.Handle(request, (_) => throw expectedException, cancellationToken));
