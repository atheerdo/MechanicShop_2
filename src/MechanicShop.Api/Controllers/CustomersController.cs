...
public sealed class CustomersController(ISender sender) : ApiController
{
    ...
    [EndpointDescription("Retrieves all customers associated with the current user.")]
    ...
    [EndpointDescription("Retrieves a specific customer associated with the current user by their unique identifier.")]
    ...
    [EndpointDescription("Adds a new customer to the system with the provided details.")]
